  ...
  list: [
    {
      ...
      descriptions: [
        'KB카드 AI플랫폼 구축 개발(SI)',
        '외부 업체로 부터 크롤링 데이터 공급받는 Flask API 개발 /GCP BigQuery Table & GCS 적재 ',
    ...
    },
    {
      ...
      descriptions: [
        ...
        'Express 로 api 서버 구축 및 모델 서버와 통신 서버 개발 구축',
    ...
    },
    {
      ...
      descriptions: [
        'LG 하우시스(SI)',
        'admin 대시보드 slowQuery 수정 및 개선 리펙토링',
    ...
    },
    {
      ...
      descriptions: [
        ...
        '산업 공정 데이터 출력을 위해 Android 플랫폼 에 RS-232 케이블 통신 S/W 및 Android UI 개발 ',
        'C# 으로 실시간 공정 데이터 출력을 위한 산업공정 통신 개발',
        'Android & Spring API 으로 공정 데이터 제어를 위한 공정 제어 시스템 개발 구축 ',
        'MES 데이터 검증을 위한 DB Table 설계',
        'Android & C# Windows Application 으로 온도 데이터 모니터링 이상 발생 시 알림 문자 푸쉬 를 위한 S/W 와 H/W 개발',
        'java Swing 으로 공정 중앙 모니터링 시스템 개발',
        'IOT 제품을 위한 Spring Web 개발',
        '배포 진행 및 S/W 설치 작업',
      ],
